...
src\AspnetWebApi2Helpers\.nuget\nuget.exe install "src\AspnetWebApi2Helpers\AspnetWebApi2Helpers.Serialization.Protobuf\packages.config" -OutputDirectory "src\AspnetWebApi2Helpers\packages" -NonInteractive
if "%debug%"=="1" pause
...
mkdir "releases\%PackageVersion%\AspnetWebApi2Helpers.Serialization.Protobuf\net45"
...
%WINDIR%\Microsoft.NET\Framework\v4.0.30319\msbuild "src\AspnetWebApi2Helpers\AspnetWebApi2Helpers.Serialization.Protobuf\AspnetWebApi2Helpers.Serialization.Protobuf.csproj" /p:Configuration="%config%" /m /v:M /fl /flp:LogFile=releases\%PackageVersion%\AspnetWebApi2Helpers.Serialization.Protobuf\net45\msbuild.log /verbosity:normal /nr:false
if "%debug%"=="1" pause
if not "%errorlevel%"=="0" exit
...
src\AspnetWebApi2Helpers\.nuget\nuget.exe pack "src\AspnetWebApi2Helpers\AspnetWebApi2Helpers.Serialization.Protobuf\AspnetWebApi2Helpers.Serialization.Protobuf.csproj" -symbols -o "releases\%PackageVersion%\AspnetWebApi2Helpers.Serialization.Protobuf\net45" -p Configuration=%config%;PackageVersion=%version%
if "%debug%"=="1" pause
if not "%errorlevel%"=="0" exit
